...
const counterRestBtn = document.getElementById('counter-reset');
...
// let today = new Date ().toISOSrting ().split('T')[0];
console.log (today);
...
function updateCountdown(e){
    e.preventDefault();
    let title = e.srcElement[0].value;
    let date = e.srcElement[1].value;
...
function restoreCountdown(){
    if(localStorage.getItem('countdown')){
        ...
        countdownData = new Date (date).getTime();
        updateDom();
    }
}
